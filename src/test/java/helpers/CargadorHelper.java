...
public class CargadorHelper {
	...
	public static Cargador crearCargadorValido() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA, WATS_VALIDOS,
				true);
	}

	// NOMBRE INVALIDO
	public static Cargador crearCargadorNombreVacio() {
		return new Cargador(NOMBRE_INVALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA, WATS_VALIDOS,
				true);
	}

	public static Cargador crearCargadorNombreTamanioInvalido() {
		return new Cargador(NOMBRE_TAMANIO_INVALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA,
				WATS_VALIDOS, true);
	}

	// MARCA INVALIDA
	public static Cargador crearCargadorMarcaVacia() {
		return new Cargador(NOMBRE_VALIDO, MARCA_INVALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA, WATS_VALIDOS,
				true);
	}

	public static Cargador crearCargadorMarcaTamanioInvalido() {
		return new Cargador(NOMBRE_VALIDO, MARCA_TAMANIO_INVALIDO, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA,
				WATS_VALIDOS, true);
	}

	// COLOR INVALIDO
	public static Cargador crearCargadorColorVacio() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_INVALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA, WATS_VALIDOS,
				true);
	}

	public static Cargador crearCargadorColorTamanioInvalido() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_TAMANIO_INVALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA,
				WATS_VALIDOS, true);
	}

	// PRECIO INVALIDO
	public static Cargador crearCargadorPrecioInvalido() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_CANTIDAD_INVALIDO, CANTIDAD_VALIDA,
				WATS_VALIDOS, true);
	}

	// CANTIDAD INVALIDA
	public static Cargador crearCargadorCantidadInvalida() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_INVALIDA, WATS_VALIDOS,
				true);
	}

	// WATS INVALIDOS
	public static Cargador crearCargadorWatsInvalidos() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA, WATS_INVALIDOS,
				true);
	}

	public static Cargador crearCargadorWatsTamanioInvalido() {
		return new Cargador(NOMBRE_VALIDO, MARCA_VALIDA, COLOR_VALIDO, PRECIO_VALIDO, CANTIDAD_VALIDA,
